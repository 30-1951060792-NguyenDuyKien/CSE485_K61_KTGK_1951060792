...
<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        $sql_update = "UPDATE db_docgia set madg = '$madg',hovaten = '$hovaten',gioitinh = '$gioitinh',namsinh = '$namsinh' where madg = '$id'";
...
?>
    ...
    <?php 
        ...
        if(isset($_GET['madg'])) {
            ...
            $sql = "SELECT * FROM db_docgia WHERE madg = '$id'";
    ...
    <div class="container">
        ...
        <form class="mt-4" method="POST" action="">
            <div class="mb-3">
                ...
                <input type="text" name="madg" class="form-control" id="madg" value="<?php echo $row['madg']; ?>">
            </div>
            <div class="mb-3">
