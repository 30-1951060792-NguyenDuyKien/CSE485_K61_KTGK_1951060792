                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="update_member.php?bd_madg=<?php echo $row['madocgia']; ?>"></i>Sửa</a></td>
                                                <td><a href="delete.php?bd_madg=<?php echo $row['madocgia']; ?>"><i class="fas fa-trash-alt"></i>Xóa</a></td>
                                            </tr>
                                    <?php
                                            $i++;
                                        }
